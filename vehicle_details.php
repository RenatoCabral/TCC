    ...
    <div class="row">
        <div class="col s12 m12 l6">
            <ul id="tabs-swipe-demo" class="tabs vehicle-details-tabs">
                ...
                <li class="tab col s4"><a href="#test-swipe-3">Dados do Vendedor</a></li>
            </ul>
            ...
            <div id="test-swipe-2" class="col s12 m12 l12 green">
                <div class="row">
                    <div class="col s12 m12 l12">Obs. Vendedor</div>
                </div>
            </div>
            <div id="test-swipe-3" class="col s12 m12 l12 blue">Dados do Vendedor</div>
        </div>
        ...
        <div class="col s12 m12 l6">
            ...
            <div class="row vehicle-details-button-enviar-proposta">
                <div class="input-field col s12 m12 l12 btn_basic_search">
                    <button class="btn waves-effect waves-light" type="submit" name="action">Enviar Mensagem
